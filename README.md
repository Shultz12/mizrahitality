...
- An unknown slug → a friendly "we couldn't find a venue at that address" page. If the owner app is down, the customer page shows a calm "try again in a moment" page — never a stack trace.
